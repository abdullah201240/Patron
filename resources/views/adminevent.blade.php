        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="adminevent" class="nav-link active">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Add Sucessfully Event</h5>
                       ...
                       <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <br>
                        <textarea name="dis" id="dis" cols="30" rows="10" style="width: 400px; height: 100px;">Description</textarea>
                        <br>
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img style="height: 100px; width: 100px" src="upload/{{ $da->image }}" alt="{{ $da->image }}"></td>
                                        <td><a href="removeevent/{{ $da->id}}"> <button type="button" class="btn btn-danger">Remove</button></a></td>
                                    </tr>
