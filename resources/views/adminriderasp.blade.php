            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header border-transparent">
                        <h3 class="card-title">Rider Apply List</h3>
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $da->drivinglicence }}</td>
                                        <td>{{ $da->address }}</td>
                                        <td>{{ $da->vehicle }}</td>
                                        <td><a href="upload/{{ $da->cv }}"> {{ $da->cv }}</a></td>
                                        <td>{{ $da->status }}</td>
                                        <td><a href="adminreqasp/{{ $da->id }}/{{$da->email}}/{{$da->name}}"><button type="button" class="btn btn-success">Accept</button></a></td>
