        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="adminriderasp" class="nav-link active">
                        ...
                        <li class="nav-item">
                            <a href="adminvolunteerasp" class="nav-link active">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Rider Apply Requests</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header border-transparent">
                        <h3 class="card-title">Volunteer Apply List</h3>
                            ...
                            <table class="table m-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="upload/{{ $da->cv }}"> {{ $da->cv }}</a></td>
                                        <td>{{ $da->status }}</td>
                                        <td><a href="adminvreqasp/{{ $da->id }}/{{$da->email}}/{{$da->name}}"><button type="button" class="btn btn-success">Accept</button></a></td>
