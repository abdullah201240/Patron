...
<body>
	...
	<nav class="navbar">
        ...
        <ul>
				<li><a href="riderhome" ><img src="images/home.png"> <span>Home</span></a></li>
				<li><a href="myride" class="active-link"><img src="images/71422.png"> <span>My Ride</span></a></li>
		...
		<div class="profile-menu-wrap" id="profileMenu">
			<div class="profile-menu">
				...
				<hr>
				<a href="riderprofile" class="profile-manu-link">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Client Phone <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Client Address <span class="icon-arrow">&UpArrow;</span></th>
                       
                        <th>Status<span class="icon-arrow">&UpArrow;</span></th>
                        <th>View Map<span class="icon-arrow">&UpArrow;</span></th>
                 ...
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$da1->faddress}}</td>
                        <td>{{$da1->status}}</td>
                        <td><a href="showmap/{{$da1->id}}"><button type="button" class="btn btn-success">View Map</button></a>
                        </td>
